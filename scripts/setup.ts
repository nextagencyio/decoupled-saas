...
${COLORS.magenta}╔════════════════════════════════════════════════════════╗
║                                                        ║
║     ${COLORS.bright}CloudFlow SaaS - Interactive Setup${COLORS.reset}${COLORS.magenta}         ║
║                                                        ║
║   Component showcase with SaaS paragraph types:          ║
...
`)
  ...
  const spaceName = await prompt('Enter a name for your components site', 'My CloudFlow Site')
  ...
  if (shouldImport) {
    ...
    log('This creates SaaS paragraph types and 4 landing pages...', 'dim')
    const importResult = await runCommand('npx', ['decoupled-cli@latest', 'content', 'import', '--file', 'data/saas-content.json'])
